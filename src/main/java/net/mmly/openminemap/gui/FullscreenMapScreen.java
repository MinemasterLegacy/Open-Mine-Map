...
public class FullscreenMapScreen extends Screen { //Screen object that represents the fullscreen map
    ...
    public void jumpToSearchBox(KeyInput input) {
         jumpToSearchBox();
    ...
    private static void drawButtons(DrawContext context) {
        //draws the buttons
        context.drawTexture(RenderPipelines.GUI_TEXTURED, //zoom in
        ...
        context.drawTexture(RenderPipelines.GUI_TEXTURED, //zoom out
                map.getZoom() > 0 ?
        ...
        context.drawTexture(RenderPipelines.GUI_TEXTURED, //reset map
        ...
        context.drawTexture(RenderPipelines.GUI_TEXTURED, //follow player
        ...
        context.drawTexture(RenderPipelines.GUI_TEXTURED, //config
        ...
        context.drawTexture(RenderPipelines.GUI_TEXTURED, //exit
        ...
        context.drawTexture(RenderPipelines.GUI_TEXTURED, //waypoints
