...
public class BugReportLayer extends ClickableWidget {
    ...
    public BugReportLayer(int x, int y, int width, int height) {
    ...
    public void drawWidget(DrawContext context, TextRenderer textRenderer) {
        ...
        context.drawText(textRenderer, Text.of("Report Bugs"), windowScaledWidth - 65, windowScaledHeight + 7 - textRenderer.fontHeight - 10 - 16, 0xFF0B9207, true);
